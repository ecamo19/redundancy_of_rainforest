...
sys.source("./codes/scripts/script_full_species_list.R", 
...
raw_data_vargas <- 
    extract_tables("./raw_data/response_traits/original_raw_data_files/lista_arboles_sindromes_OVR05.pdf", 
...
# Join reproductive traits data with Wood density data
...
```{r}
#write.csv(raw_data_complete,"./data_for_analisys/raw_data_complete_dont_modify.csv")
```
